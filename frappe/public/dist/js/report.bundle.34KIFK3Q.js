(() => {
  ...
  frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
    ...
    get_filters_html_for_print() {
      const applied_filters = this.get_filter_values();
      return Object.keys(applied_filters).filter((fieldname) => !frappe.utils.is_empty(applied_filters[fieldname])).map((fieldname) => {
  ...
  // frappe-html:/home/gopichand-gusidi/frappe-lms/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_grid.html
...
`;
  ...
  // frappe-html:/home/gopichand-gusidi/frappe-lms/frappe-bench/apps/frappe/frappe/public/js/frappe/views/reports/print_tree.html
...
`;
  ...
  // frappe-html:/home/gopichand-gusidi/frappe-lms/frappe-bench/apps/frappe/frappe/public/js/frappe/ui/group_by/group_by.html
...
//# sourceMappingURL=report.bundle.34KIFK3Q.js.map
